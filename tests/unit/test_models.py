from wordle.core.models import Clue, Word, ClueEnum, Guess, Answer, Attempt
import pytest
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "bingi",
            "bingo",
            Clue(letter_clues=[ClueEnum.correct] * 4 + [ClueEnum.wrong]),
            marks=pytest.mark.xfail(reason="We don't respect frequency of letters yet."),
        ),
